# texet Web Application

texet is a real-time web chat application built with Flask and Socket.IO. It provides a seamless and interactive platform for users to communicate with each other through individual chat rooms.
...
To run the texet web application locally, follow these steps:
...
Visit `http://localhost:5000` in your web browser to access texet.
